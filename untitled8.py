...
Original file is located at
    https://colab.research.google.com/drive/1vijkY0cTw1XBNGvnh-UdokOYOyWywIH5
"""
...
# Example usage
wav_file_path = '1-ovoz.wav'  # Replace with your WAV file path
...
# Matnni belgilash
text =" can you tell me something about your study place  "
...
# Example usage
wav_file_path = '2-ovoz.wav'  # Replace with your WAV file path
generate_spectrogram(wav_file_path)
...
# Example usage
wav_file_path = '3-ovoz.wav'  # Replace with your WAV file path
generate_spectrogram(wav_file_path)